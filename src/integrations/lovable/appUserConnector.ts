 ...
 *
 * These functions read server-side secrets from process.env and talk to the
 * Lovable connector gateway. Never import this module from a route component,
 * loader, or any other client-bundled file.
 */
